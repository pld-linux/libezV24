...
Prosty w użyciu interfejs programowy do linuksowych portów
szeregowych.
...
Ten pakiet zawiera pliki nagłówkowe i inne zasoby przydatne przy
używaniu libezV24 w aplikacjach.
...
Ten pakiet zawiera statyczną bibliotekę libezV24.
